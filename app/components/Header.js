        ...
        <div className="w-11/12 max-w-4xl mx-auto h-screen flex flex-col items-center justify-center text-center gap-6 px-4 pt-16 ">
            ...
            >
                <Image
                    ...
                    alt="Profile"
                    className="rounded-full w-48 border-4 border-gray-300 shadow-lg transform hover:scale-105 transition-all duration-300"
                />
            </motion.div>
            ...
            >
                Hi! I'm <span className="text-blue-500 font-bold">Harsh Jaiswal</span>
                <motion.div
                    initial={{ rotate: -15 }}
                    animate={{ rotate: 0 }}
    ...
    Let's bring your vision to life with creativity and code!
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-6">
                ...
                <motion.a
                    ...
                    href="#contact"
                    className="font-Outfit px-8 py-3 rounded-full bg-blue-500 text-white font-medium
          hover:bg-blue-600 hover:scale-105 hover:shadow-lg transition-all duration-300 shadow-md flex items-center gap-2"
                >
                    Contact Me
